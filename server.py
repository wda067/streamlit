...
def load_model():
    ...
    reader = easyocr.Reader(['en'], detect_network='craft', recog_network='best_acc', user_network_directory='wda067/streamlit/lp_models/user_network', model_storage_directory='wda067/streamlit/lp_models/models')
